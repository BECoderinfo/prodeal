...
const { insertRequestBusiness, createBusiness, getBusinessById, updateBusinessById, deleteBusinessById, getAllBusinesses, getAllRequestBusinesses, acceptBusinessRequest, rejectBusinessRequest, totalEarnings, weeklySales, UploadMenuImage, UploadStoreImage, UploadMainImage,WateridentyUpload,GovermentIdUpload} = require('../controllers/BusinessController');
...
businessRouter.get("/weeklySales", weeklySales);
